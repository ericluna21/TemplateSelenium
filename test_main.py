...
def test_setUp():
    ...
    for i in range(20):
        ...
        producto1 = driver.find_element_by_xpath(
            "//body/div[@id='page']/div[@id='content']/div[@id='primary']/main[@id='main']/section[2]/div[1]/div[2]/div[1]/div[5]/a[1]")
        producto1.click()
        driver.implicitly_wait(8)
        seleccionar_cantidad = driver.find_element_by_xpath('//div/input')
        seleccionar_cantidad.send_keys(1)
        btn_agregarcarrito = driver.find_element_by_xpath(
        ...
        btn_agregarpedido = driver.find_element_by_xpath("//a[contains(text(),'Confirmar Solicitud')]")
        btn_agregarpedido.click()

        driver.implicitly_wait(5)
        driver.execute_script("window.scrollTo(0,1633)")
        driver.find_element(By.XPATH, "(//input[@id=\'\'])[2]").click()
        driver.find_element(By.ID, "billing_distributor_province").click()
        dropdown1 = driver.find_element(By.ID, "billing_distributor_province")
        time.sleep(3)
        dropdown1.find_element(By.XPATH, "//option[. = 'FORMOSA']").click()
        time.sleep(4)
        driver.find_element(By.ID, "billing_distributor_locality").click()
        time.sleep(4)
        dropdown2 = driver.find_element(By.ID, "billing_distributor_locality")
        driver.implicitly_wait(4)
        dropdown2.find_element(By.XPATH, "//option[. = 'FORMOSA']").click()
        driver.find_element(By.XPATH, "//p[@id=\'billing_distributor_field\']/span/select").click()
        driver.implicitly_wait(4)
        dropdown3 = driver.find_element(By.ID, "billing_distributor")
        driver.implicitly_wait(4)
        ...
        driver.implicitly_wait(5)
        driver.find_element(By.ID, "js-keep-buying").click()
